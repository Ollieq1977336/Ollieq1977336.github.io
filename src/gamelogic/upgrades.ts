...
export const generators = [
   new Generator(
      1, // id
      'Host Advertising', // name
      'Gain 1 Pound every 10 seconds', // description
      10, // base price
      1.1, // multiplier
   ...
   new Generator(
      2,
      'Advertising bot',
      'Automatically hosts an advertisement every 10 seconds',
      200,
      1.2,
      1,
      10
   ...
   new Generator(
      3,
      'Advertising Bot Coder',
      'Codes an Advertising bot every 10 seconds',
      5000,
      1.3,
      2,
      10
   ...
   new Generator(
      4,
      'Make a Job Website/Advertise your website',
      'Automatically hires a Advertising Bot Coder Every 10 Seconds',
      50000,
      1.4,
      3,
      10
